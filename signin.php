  ...
  <body>
    <div class="container">
      ...
      <form class="form-signin" action="" method="POST">
        ...
        <a class="btn btn-lg btn-osu btn-block" href="https://login.oregonstate.edu/cas/login?service=http%3A%2F%2Fweb.engr.oregonstate.edu%2F~elliomic%2Fcs290-project%2Fverify.php">Log in through OSU</a>
        <br>
