  ...
  <body>
    ...
    <div class="breadcrumbs">
      ...
      » About
		...
		<p>
		For the annals of history, here are the members of the Fellowship of the Wingding:
		</p>
		<ul>
			<li>Brandon Chatham, a swordsman equally quick with his sword and feet; on the eve of the final battle he stared down the monster and did not blink</li>
			<li>Andrew Ekstedt, a sorceror of untold power; his knowledge of the arcane complimented his natural ability as he led the Fellowship </li>
			<li>Michael Elliott, an assassin that struck from the shadows; legend holds that it was his blow that felled the monster</li>
			<li>Jacob Mahugh, an elaborate storyteller that wielded a bo staff of fire; the only thing more fiery was his wit</li>
			<li>Ian McQuoid, a druid with powerful ability to control plants; legend holds that he left his order, which was focused on plants, to aid the Fellowship</li>
			<li>Xiaoli Sun, an archer of uncanny accuracy; his covering fire allowed the rest of the Fellowship to close in the for final blow</li>
		</ul>
		</div>
